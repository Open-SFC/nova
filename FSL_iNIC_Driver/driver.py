...
from nova.virt.libvirt.freescale import vif as libvirt_vif
...
class LibvirtDriver(driver.ComputeDriver):
	...
	self.vif_driver = libvirt_vif.FreescaleiNicDriver(
            self._get_connection,
            self.get_available_resource(CONF.fsl_sriov.host))
